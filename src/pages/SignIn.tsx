      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="absolute bottom-10 left-10 text-white">
          ...
          <p className="text-base sm:text-lg text-gray-300">
            Sign in to continue your journey through endless entertainment.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gradient-to-br from-[#0f1219] via-[#171b2c] to-[#1f1635] p-4 sm:p-8">
        <div className="w-full max-w-md space-y-6 sm:space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm sm:text-base text-gray-400">Welcome back to your entertainment hub</p>
          </div>
